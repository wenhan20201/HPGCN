...
from hpgcn import __version__
from hpgcn.apis import init_random_seed, train_model
from hpgcn.datasets import build_dataset
from hpgcn.models import build_model
from hpgcn.utils import collect_env, get_root_logger, mc_off, mc_on, test_port
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        # save hpgcn version, config file content and class names in
        # checkpoints as meta data
        cfg.checkpoint_config.meta = dict(
            hpgcn_version=__version__ + get_git_hash(digits=7),
