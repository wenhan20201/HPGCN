...
from hpgcn.datasets import build_dataloader, build_dataset
from hpgcn.models import build_model
from hpgcn.utils import cache_checkpoint, mc_off, mc_on, test_port
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='hpgcn test (and eval) a model')
