...
model = dict(
    ...
    cls_head=dict(type='SimpleHead', joint_cfg='nturgb+d', num_classes=60, in_channels=384, weight=0.1))

dataset_type = 'PoseDataset'
ann_file = '/mnt/newdrive/wenhan/projecth/ProtoGCN2/data/nturgbd/ntu60_3danno.pkl'
train_pipeline = [
