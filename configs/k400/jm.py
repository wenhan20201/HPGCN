...
model = dict(
    ...
    cls_head=dict(type='SimpleHead', joint_cfg='coco_new', num_classes=400, in_channels=384, weight=0.2))

memcached = True
mc_cfg = ('localhost', 22077)
dataset_type = 'PoseDataset'
ann_file = '/mnt/newdrive/wenhan/projecth/ProtoGCN2/data/k400/k400_hrnet.pkl'
