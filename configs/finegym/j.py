...
#resume_from = 'work_dirs/finegym/j/epoch_85.pth'
...
model = dict(
    ...
    cls_head=dict(type='SimpleHead', joint_cfg='coco_new', num_classes=99, in_channels=384, weight=0.2))

dataset_type = 'PoseDataset'
ann_file = '/mnt/newdrive/wenhan/projecth/ProtoGCN2/data/finegym/gym_hrnet.pkl'
