#resume_from = '/mnt/newdrive/wenhan/projecth/ProtoGCN2/work_dirs/ntu120_xsub/jm/epoch_78.pth'
...
model = dict(
    ...
    backbone=dict(
        type='HPGCN',
        num_proto_low=256,     # 低层局部原型
        num_proto_high=128,    # 高层语义原型
        tcn_ms_cfg=[(3, 1), (3, 2), (3, 3), (3, 4), ('max', 3), '1x1'],
        graph_cfg=dict(layout=graph, mode='part6', num_filter=8, init_off=.04, init_std=.02)),
    cls_head=dict(type='SimpleHead', joint_cfg='nturgb+d', num_classes=120, in_channels=384, weight=0.2))

dataset_type = 'PoseDataset'
ann_file = '/mnt/newdrive/wenhan/projecth/ProtoGCN2/data/nturgbd/ntu120_3danno.pkl'
train_pipeline = [
